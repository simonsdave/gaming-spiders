...
def _get_long_description():
    try:
        ...
        with open(os.path.join(abs_dirname_for_this_file, 'README.rst'), 'r', encoding='utf-8') as f:
            return ('text/x-rst; charset=UTF-8', f.read())
    except IOError:
        # simple fix for avoid failure on "source cfg4dev"
        return ('text/plain; charset=UTF-8', 'a long description')


(_long_description, _long_description_content_type) = _get_long_description()
