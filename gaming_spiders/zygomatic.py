...
class ZygomaticSpider(spider.Spider):
    ...
    def crawl(self, browser):
        ...
        title_elements = web_driver_wait.until(lambda browser: browser.find_elements_by_xpath(xpath))
        ...
        link_elements = web_driver_wait.until(lambda browser: browser.find_elements_by_xpath(xpath))
